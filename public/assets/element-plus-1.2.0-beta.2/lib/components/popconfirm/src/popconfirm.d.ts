...
export declare const popconfirmProps: {
    ...
    readonly confirmButtonType: import("element-plus/es/utils/props").BuildPropReturn<StringConstructor, "primary", unknown, "" | "default" | "text" | "success" | "warning" | "info" | "primary" | "danger", unknown>;
    readonly cancelButtonType: import("element-plus/es/utils/props").BuildPropReturn<StringConstructor, "text", unknown, "" | "default" | "text" | "success" | "warning" | "info" | "primary" | "danger", unknown>;
