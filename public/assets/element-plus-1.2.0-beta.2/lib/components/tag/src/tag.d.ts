...
export declare const tagProps: {
    ...
    readonly size: import("element-plus/es/utils/props").BuildPropReturn<StringConstructor, unknown, unknown, "small" | "medium" | "large" | "mini", unknown>;
    readonly effect: import("element-plus/es/utils/props").BuildPropReturn<StringConstructor, "light", unknown, "dark" | "light" | "plain", unknown>;
};
