export declare const ElSpace: import("../../utils/types").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly size: import("../../utils/props").BuildPropReturn<readonly [StringConstructor, ArrayConstructor, NumberConstructor], unknown, unknown, "small" | "medium" | "large" | "mini", number | [number, number]>;
    ...
    size?: import("../../utils/props").BuildPropType<readonly [StringConstructor, ArrayConstructor, NumberConstructor], "small" | "medium" | "large" | "mini", number | [number, number]> | undefined;
    prefixCls?: string | undefined;
}>, {
    fill: import("../../utils/props").BuildPropType<BooleanConstructor, unknown, unknown>;
    size: import("../../utils/props").BuildPropType<readonly [StringConstructor, ArrayConstructor, NumberConstructor], "small" | "medium" | "large" | "mini", number | [number, number]>;
    style: import("vue").StyleValue;
    wrap: import("../../utils/props").BuildPropType<BooleanConstructor, unknown, unknown>;
    class: import("../../utils/props").BuildPropType<import("../../utils/props").PropWrapper<string | string[] | Record<string, boolean>>, unknown, unknown>;
    direction: import("../../utils/props").BuildPropType<StringConstructor, "horizontal" | "vertical", unknown>;
