...
export declare const spaceProps: {
    ...
    readonly size: import("element-plus/es/utils/props").BuildPropReturn<readonly [StringConstructor, ArrayConstructor, NumberConstructor], unknown, unknown, "small" | "medium" | "large" | "mini", number | [number, number]>;
};
...
declare const _default: import("vue").DefineComponent<{
    ...
    size?: import("element-plus/es/utils/props").BuildPropType<readonly [StringConstructor, ArrayConstructor, NumberConstructor], "small" | "medium" | "large" | "mini", number | [number, number]> | undefined;
    prefixCls?: string | undefined;
}>, {
    fill: import("element-plus/es/utils/props").BuildPropType<BooleanConstructor, unknown, unknown>;
    size: import("element-plus/es/utils/props").BuildPropType<readonly [StringConstructor, ArrayConstructor, NumberConstructor], "small" | "medium" | "large" | "mini", number | [number, number]>;
    style: StyleValue;
    wrap: import("element-plus/es/utils/props").BuildPropType<BooleanConstructor, unknown, unknown>;
    class: import("element-plus/es/utils/props").BuildPropType<import("element-plus/es/utils/props").PropWrapper<string | string[] | Record<string, boolean>>, unknown, unknown>;
    direction: import("element-plus/es/utils/props").BuildPropType<StringConstructor, "horizontal" | "vertical", unknown>;
