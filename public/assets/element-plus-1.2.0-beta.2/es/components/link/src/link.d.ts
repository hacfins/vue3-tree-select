...
export declare const linkProps: {
    readonly type: import("element-plus/es/utils/props").BuildPropReturn<StringConstructor, "default", unknown, "default" | "success" | "warning" | "info" | "primary" | "danger", unknown>;
