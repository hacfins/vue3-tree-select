declare const _default: import("vue").DefineComponent<{
    ...
    arrowRef: import("vue").Ref<import("./use-popper/defaults").RefElement>;
    events: import("./use-popper/index").PopperEvents;
    popperId: string;
    popperInstance: null;
    popperRef: import("vue").Ref<import("./use-popper/defaults").RefElement>;
    ...
    popperClass: string;
    pure: boolean;
    popperOptions: Partial<import("@popperjs/core/lib/types").Options>;
    showArrow: boolean;
    transition: string;
